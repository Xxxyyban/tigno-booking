...
<head>
    ...
    <style>
        *{ box-sizing:border-box; }
        ...
        .password-toggle{ position:absolute; right:15px; top:14px; color:#94a3b8; cursor:pointer; font-size:18px; }
        ...
        .btn-create{ margin-top:25px; width:100%; height:55px; border:none; border-radius:15px; background: linear-gradient(135deg, #fb7185, #e11d48); color:white; font-weight:700; font-size:16px; transition:.3s; }
        ...
        @media(max-width:900px){
            .register-card{ grid-template-columns:1fr; width:95%; }
            .left{ display:none; }
        }
    </style>
</head>
...
<div class="register-card">
    ...
    <div class="right">
        ...
        <form method="POST" action="{{ route('customer.register.store') }}">
            ...
            <div class="login">
                Already have account? <a href="{{ route('login.user') }}">Login</a>
            </div>
        </form>
    </div>
</div>
